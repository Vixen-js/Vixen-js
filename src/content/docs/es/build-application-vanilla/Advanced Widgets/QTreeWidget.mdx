---
title: QTreeWidget
description: Cómo usar QTreeWidget en tu aplicación
---

import { Code } from '@astrojs/starlight/components';

> **QTreeWidget** es un widget que proporciona un arbol que puedes utilizar en tu aplicación.
...
Aprende mas sobre `QTreeWidget` en: https://doc.qt.io/qt-6/qtreewidget.html