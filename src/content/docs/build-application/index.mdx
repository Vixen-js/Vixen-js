...
description: How to use the Vixen UI to build a ssimple application
---
...
**Important Note:** we recommend to have 2 terminals opened for development purposes. One for **_development_** and another for **_watch_** server.

## Development

To start the watch server, run the following command:
```bash
pnpm watch
```

After this, you can start your application running the following command:
```bash
pnpm dev
```
